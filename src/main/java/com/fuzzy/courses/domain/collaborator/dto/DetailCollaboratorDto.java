...
public record DetailCollaboratorDto(
    ...
    public DetailCollaboratorDto(Collaborator collaborator) {
        this(collaborator.getId(), collaborator.getFullName(), collaborator.getCollaboratorRecord(), collaborator.getEmail(), collaborator.getPhone(), collaborator.getCollaboratorDepartment().getDepartment(), collaborator.getCollaboratorPosition().getPosition(), collaborator.getCourses());
    }
}
